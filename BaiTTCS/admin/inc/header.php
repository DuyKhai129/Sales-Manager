    ...
    <div class="container_12">
                ...
                <div class="floatright">
                    ...
                    <div class="floatleft marginleft10">
                        <ul class="inline-ul floatleft">
                            <li> Hi <?php echo Session::get('adminName') ?></li>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-grid-tables"><a href="inbox.php"><span>Thông tin đơn hàng</span></a></li>
                <li class="ic-charts"><a href="http://localhost/BaiTTCS/index.php"><span>Truy cập trang web</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>
