...
<?php
	...
	class cart
	{
		...
		public function insertOrder($customer_id){
			...
			if($get_product){
				while($result = $get_product->fetch_assoc()){
					...
					$query_order = "INSERT INTO orders(productId,productName,quantity,price,image,customer_id) VALUES('$productid','$productName','$quantity','$price','$image','$customer_id')";
		...
		public function del_shifted($id,$time,$price){
			...
			$result = $this->db->update($query);
			if($result){
				$msg = "<span class='success'>Xóa đơn hàng thanh công</span>";
				return $msg;
			}else{
				$msg = "<span class='error'>Xóa đơn hàng ko thanh công</span>";
				return $msg;
			}
		}
