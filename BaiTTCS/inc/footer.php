   ...
   <div class="footer">
	     ...
	     <div class="section group">
				<div class="col_1_of_4 span_1_of_4">
						...
						<li><a href="contact.php"><span>Liên hệ chúng tôi</span></a></li>
						</ul>
					</div>
				<div class="col_1_of_4 span_1_of_4">
					<h4>thông tin web</h4>
						...
						<li><a href="index.php"><span>Tìm kiếm</span></a></li>
						</ul>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<h4>TÀI KHOẢN CỦA TÔI</h4>
						<ul>
							...
							<li><a href="orderdetails.php">Đơn hằng</a></li>
							<li><a href="#">Help</a></li>
						</ul>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<h4>Liên hệ</h4>
						<ul>
							<li><span>+99-90909090909</span></li>
							<li><span>+99-09090909090</span></li>
						</ul>
